...
def call(){
   script{
      ...
      if ((env.resource == "aws-vpc-config") || (env.resource == "aws-eks-cdn") || (env.resource == "aws-3t-arch") || (env.resource == "aws-instance-schedular") || (env.resource == "eks") || (env.resource == "iam") || (env.resource == "aws-cicd-sw") || (env.resource == "aws-cicd-ms") || (env.resource == "aws-rds-stack") || (env.resource == "aws-3t-wp")|| (env.resource == "iam-user-policy"))  {
         sh """
